  ...
  return (
    <div className="min-h-screen bg-gradient-image bg-cover bg-center bg-[#070B14] flex flex-col items-center justify-center px-4">
      ...
      <p className="text-center text-lg mt-8 max-w-md mx-auto bg-gradient-to-r from-[#4469EC] to-[#95A3FF] bg-clip-text text-transparent font-medium">
        COMPLETE FUN TASKS TO EARN LOVEBITS POINTS (LP)
      </p>
      <p className="text-center text-lg text-gray-300 mt-8 mb-12 max-w-md mx-auto">Each task completed brings you closer to your rewards.</p>

      {/* Button with gradient and glow effect */}
      <div className="flex gap-2">
        <button className="relative group" onClick={tasks}>
        <div className="relative px-8 py-3.5 rounded-lg bg-black border border-[#002aa1]">
                <span className="font-medium text-lg bg-gradient-to-r from-[#020aa1] via-[#fff] to-[#020aa1] bg-clip-text text-transparent">VIEW TASKS</span>
            </div>
        </button>
        <button 
