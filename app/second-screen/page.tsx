...
export default function OpenScreen() {
  ...
  return (
    <div className="min-h-screen bg-[url('/darkbg.svg')] bg-cover bg-center flex flex-col items-center justify-center px-4">
      ...
      <p className="text-center text-lg text-gray-300 mt-8 mb-12 max-w-md mx-auto">
        Each task completed brings you closer to your rewards.
      </p>
      ...
      <div className="flex gap-2">
        <button className="relative group" onClick={tasks}>
          <div className="relative px-8 py-3.5 rounded-lg bg-black border border-[#002aa1]">
            <span className="font-medium text-lg bg-gradient-to-r from-[#020aa1] via-[#fff] to-[#020aa1] bg-clip-text text-transparent">
              VIEW TASKS
            </span>
          </div>
        </button>
