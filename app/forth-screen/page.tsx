...
export default function OpenScreen() {
  ...
  return (
    <div className="min-h-screen bg-gradient-image bg-cover bg-center bg-[#070B14] flex flex-col items-center justify-center px-4">
      ...
      <p className="text-center text-lg text-gray-300 mt-8 mb-8 max-w-md mx-auto">Follow us on social media and join our Telegram group</p>
      ...
      <div className="flex gap-2">
        ...
        <div className="relative px-6 py-3.5 rounded-lg bg-black border border-[#002aa1]">
                <span className="font-medium text-sm bg-gradient-to-r from-[#020aa1] via-[#fff] to-[#020aa1] bg-clip-text text-transparent">VIEW SOCIAL LINKS</span>
            </div>
        </button>
        <button 
